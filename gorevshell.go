...
// banner
func print_banner(){
    banner := figure.NewFigure("GO REVERSE SHELL", "", true)
...
// func for input while connecting to the victim pc
...
// func for creating file in the victim pc
...
// func for reading files in the victim pc
...
// func for printing error while connection
...
// func for getting the victim local ip
...
// function for sending random string
